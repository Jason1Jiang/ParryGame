...
### v3.3 - 玩家死亡动画系统（2025-12-18）💀✨
**重大功能更新**:
- ✅ **粒子爆散**: 100个粒子从玩家位置向360度飞散，3种颜色分层
  - 30% 白色核心粒子（最亮，速度最快）
  - 50% 玩家色主体粒子（中等速度）
  - 20% 青色余烬粒子（速度慢，带拖尾）
- ✅ **延迟结算**: 死亡动画播放2.2秒后再显示结算界面
...
**性能影响**: CPU +0.1-0.2ms/帧，GPU +0.2-0.3ms/帧，内存 +10KB（可忽略，动画仅持续2.2秒）
