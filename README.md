...
### v3.5.4 - 点击外部关闭排行榜（2024-12-19）✨
**用户体验改进**:
- ✅ **点击外部关闭**: 点击排行榜外的半透明背景即可关闭
- ✅ **模态对话框**: 采用现代模态对话框设计，全屏遮罩
- ✅ **多种关闭方式**: 支持点击"返回"按钮或点击外部区域

**使用方法**:
- 查看排行榜时，点击外部任意位置即可关闭
- 或点击底部"返回"按钮

**详细文档**: [CLICK_OUTSIDE_CLOSE_v3.5.4.md](CLICK_OUTSIDE_CLOSE_v3.5.4.md)

### v3.5.3 - 排名显示与性能优化（2024-12-19）🏅
**新增功能**:
- ✅ **排名显示**: 提交成绩后在排行榜顶部显示此次的排名
